          ...
          fetchedPositionsRef.current &&
            fetchedPositionsRef.current.day.map((p) => {
              ...
              if (
                ...
                trailingStopLossRef.current[currentToken] == true
              ) {
                if (
                  ...
                  if (
                    Number(stopLossRef.current[currentToken]) + 1 <
                    String(tick.last_price)
                  ) {
                    setStopLoss((prev) => {
                      return {
                        ...prev,
                        [currentToken]: String(Number(tick.last_price) - 1),
                      };
                    });
                  }
                }
              ...
              if (
                ...
                stopLossRef.current[currentToken] != "0"
              ) {
                if (
                  String(p.instrument_token) === String(tick.instrument_token)
                ) {
                  if (p.quantity > 0) {
                    if (
                      ...
                      Number(stopLossRef.current[Number(p.instrument_token)])
                    ) {
